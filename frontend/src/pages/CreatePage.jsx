...
function CreatePage() {
  ...
  // Handle form submission to create the page
  const handleSubmit = (e) => {
    ...
    setIsCreated(true); // Switch to preview mode
    console.log("Page created with data:", formData);
          ...
          <div className="contact-section">
            ...
            <ul>
              {formData.contactLinks.email && (
                <li>Email: <a href={`mailto:${formData.contactLinks.email}`}>{formData.contactLinks.email}</a></li>
              )}
              {formData.contactLinks.phone && (
                <li>Phone: <a href={`tel:${formData.contactLinks.phone}`}>{formData.contactLinks.phone}</a></li>
              )}
              {formData.socialLinks.map((link, index) => (
                link.url && (
                  <li key={index}>
